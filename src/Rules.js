...
class FullHouse extends Rule {
  evalRoll = dice => {
    ...
    // only have two unique values, and frequency must be two or three
    return d.size === 2 &&
...
class SmallStraight extends Rule {
  evalRoll = dice => {
    ...
    // small straight must be 4 or more different dice
    // & must contain 1 and 2, 2 and 5, 5 and 6
...
class LargeStraight extends Rule {
  evalRoll = dice => {
    ...
    console.log(d.size === 5 && (!d.has(1) || !d.has(6)) ? this.score : 0);
